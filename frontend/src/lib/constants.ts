...
export const ASSETS: Asset[] = [
  // AI & ML - price = valuation in $ (1B synthetic shares)
  ...
  { id: "xai", symbol: "XAI", name: "xAI", price: 50, change24h: -0.5, category: "AI", logo: LOGOS.xai, marketCap: 50 },
  { id: "perplexity", symbol: "PERPLEXITY", name: "Perplexity", price: 9, change24h: 3.2, category: "AI", logo: LOGOS.perplexity, marketCap: 9 },
  { id: "groq", symbol: "GROQ", name: "Groq", price: 2.8, change24h: 5.1, category: "AI", logo: LOGOS.groq, marketCap: 2.8 },

  // Aerospace - price = valuation in $ (1B synthetic shares)
  { id: "spacex", symbol: "SPACEX", name: "SpaceX", price: 350, change24h: 1.2, category: "AEROSPACE", logo: LOGOS.spacex, marketCap: 350 },
  { id: "anduril", symbol: "ANDURIL", name: "Anduril", price: 14, change24h: -1.5, category: "AEROSPACE", logo: LOGOS.anduril, marketCap: 14 },
  { id: "shieldai", symbol: "SHIELDAI", name: "Shield AI", price: 5.3, change24h: 0.8, category: "AEROSPACE", logo: LOGOS.shieldai, marketCap: 5.3 },

  // FinTech - price = valuation in $ (1B synthetic shares)
  { id: "stripe", symbol: "STRIPE", name: "Stripe", price: 70, change24h: 0.9, category: "FINTECH", logo: LOGOS.stripe, marketCap: 70 },
  { id: "revolut", symbol: "REVOLUT", name: "Revolut", price: 45, change24h: 2.1, category: "FINTECH", logo: LOGOS.revolut, marketCap: 45 },
  { id: "ripple", symbol: "RIPPLE", name: "Ripple", price: 11, change24h: -2.3, category: "FINTECH", logo: LOGOS.ripple, marketCap: 11 },
  { id: "kraken", symbol: "KRAKEN", name: "Kraken", price: 10, change24h: 1.7, category: "FINTECH", logo: LOGOS.kraken, marketCap: 10 },

  // Data & Enterprise - price = valuation in $ (1B synthetic shares)
  { id: "databricks", symbol: "DATABRICKS", name: "Databricks", price: 62, change24h: 1.5, category: "DATA", logo: LOGOS.databricks, marketCap: 62 },
  { id: "canva", symbol: "CANVA", name: "Canva", price: 26, change24h: 0.3, category: "DATA", logo: LOGOS.canva, marketCap: 26 },
  { id: "vercel", symbol: "VERCEL", name: "Vercel", price: 3.5, change24h: 4.2, category: "DATA", logo: LOGOS.vercel, marketCap: 3.5 },

  // Social & Consumer - price = valuation in $ (1B synthetic shares)
  { id: "bytedance", symbol: "BYTEDANCE", name: "ByteDance", price: 300, change24h: -0.8, category: "SOCIAL", logo: LOGOS.bytedance, marketCap: 300 },
  { id: "discord", symbol: "DISCORD", name: "Discord", price: 15, change24h: 1.9, category: "SOCIAL", logo: LOGOS.discord, marketCap: 15 },
];
